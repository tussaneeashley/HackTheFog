...
public class tazklevellerapp {
	...
	private void initialize() {
		...
		ImageIcon notokay = new ImageIcon("./Img/Not feeling Good.png");
		JLabel notokaylabel = new JLabel(notokay);
		
		
		
		notokaylabel.setBounds(130, 198, 334, 323);
